    ...
    <>
      <svg viewBox="0 -20 300 100">
        ...
        >
          <rect
            x={0}
            fill={`var(--rightsurface,${dark1000})`}
            y={0}
            width={20}
            height={20}
            transform="skewY(30)"
          ...
          <rect
            x={0}
            fill={`var(--leftsurface,${dark10000})`}
            y={0}
            width={20}
            height={20}
            transform="skewY(-30) translate(20, 23.1)"
            rx={1}
          />
          <rect
            x={0}
            fill={`var(--leftsurface,${dark100})`}
            y={0}
            width={20}
            height={20}
            transform="scale(1.41,.81) rotate(45) translate(0 -20)"
            rx={1}
          />
        </g>
      </svg>
...
function renderManyCube() {
  ...
  return (
    <svg
      onClick={() => setIsInMorph(true)}
      className={isInMorph ? 'in-morph' : ''}
      viewBox="-21 -10 300 300"
    >
      {/* 0 diagonal row <><><> */}
